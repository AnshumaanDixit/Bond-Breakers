...
export class Menu extends Phaser.Scene {
    ...
    create() {
        const enemy1 = new Enemy(this,300,275,'idle','fe','water');
        enemy1.setFlipX(true);
        enemy1.setDepth(100);
        //^^made enemy with 'fe' element and weakness 'water'
        const enemy2 = new Enemy(this,700,275,'idle','fe','hydrogen');
        enemy2.setFlipX(true);
        enemy2.setDepth(100);
        const enemy3 = new Enemy(this,1100,275,'idle','fe','na');
        enemy3.setFlipX(true);
        enemy3.setDepth(100);
        const enemy4 = new Enemy(this,1500,275,'idle','fe','s');
        ...
        this.atk.on('pointerdown',()=>{
            this.player.attack(this.elements[this.activeAtkIndex]);
        })
